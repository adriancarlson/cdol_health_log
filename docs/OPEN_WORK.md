...
12. Install and validate inventory-entry corrections with both `ADDED_IN_ERROR` and the existing/new Wrong Number Entered code forms, including partial corrections, fully hidden corrected lots, adjusted denominators, and preserved Inventory Activity history.
